...
/**
 * FloatingDock — общий контейнер для кнопки «Наверх» и плавающего агента.
...
export function FloatingDock() {
  ...
  const agentVisible = currentView !== 'home' && !!currentCategory && !chatOpen;
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col-reverse items-center gap-3 pointer-events-none">
      {/* ScrollToTop — всегда внизу (из-за flex-col-reverse рендерится первым, но визуально последний) */}
