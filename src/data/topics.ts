...
enc.free(); // Освобождаем ресурсы`,
  ...
  <text x="300" y="175" text-anchor="middle" fill="var(--muted-foreground)" font-size="11">"неделя" → [ноделя] (1 токен) | "сверхдержава" → [сверх, держ, ава] (3 токена)</text>
